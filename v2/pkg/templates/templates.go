...
import (
	...
	"Ernuclei/v2/pkg/protocols/common/variables"
	"Ernuclei/v2/pkg/protocols/dns"
	"Ernuclei/v2/pkg/protocols/file"
	"Ernuclei/v2/pkg/protocols/headless"
	"Ernuclei/v2/pkg/protocols/http"
	"Ernuclei/v2/pkg/protocols/network"
	"Ernuclei/v2/pkg/protocols/ssl"
	"Ernuclei/v2/pkg/protocols/websocket"
	"Ernuclei/v2/pkg/protocols/whois"
