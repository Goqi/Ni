...
import (
	...
	"Ernuclei/v2/pkg/core/inputs/hybrid"
	"Ernuclei/v2/pkg/output"
	"Ernuclei/v2/pkg/parsers"
	"Ernuclei/v2/pkg/progress"
	"Ernuclei/v2/pkg/projectfile"
	"Ernuclei/v2/pkg/protocols"
	"Ernuclei/v2/pkg/protocols/common/automaticscan"
	...
	yamlwrapper "Ernuclei/v2/pkg/utils/yaml"
