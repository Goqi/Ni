...
import (
	...
	"Ni/pkg/model"
	"Ni/pkg/protocols"
	"Ni/pkg/protocols/code"
	"Ni/pkg/protocols/common/variables"
	"Ni/pkg/protocols/dns"
	"Ni/pkg/protocols/file"
	"Ni/pkg/protocols/headless"
	"Ni/pkg/protocols/http"
	"Ni/pkg/protocols/javascript"
	"Ni/pkg/protocols/network"
	"Ni/pkg/protocols/ssl"
	"Ni/pkg/protocols/websocket"
	"Ni/pkg/protocols/whois"
